...
class ProductsControllerTest < ActionDispatch::IntegrationTest
	...
	test 'render a list of product filtered by category' do
	...
	test 'render a list of product filtered by min_price and max_price' do
	...
	test 'sort a product by expensive prices first' do
	...
	test 'sort a product by chepeast prices first' do
		get products_path(order_by: 'expensive')
